...
#### debug
채널 주제(Topic)에 대소문자 무관 `debug<인원 수>`를 포함시키면 봇을 실행할 때마다 해당 인원 수의 디버그 게임이 시작됩니다. 디버그 게임은 서버 소유자 한 명만이 플레이어가 되어 명령어를 통해 가상의 여러 플레이어를 조작합니다. 주제 예시: `debug4`, 명령어 예시: `3 r 46`
